  ...
  return (
    <div className="bg-slate-950/80 border border-cyan-500/30 rounded p-3.5 backdrop-blur-md shadow-[0_0_15px_rgba(0,240,255,0.08)]">
      ...
      <div className="flex justify-between items-baseline mb-2">
        <div className="text-[10px] font-mono text-slate-400">REAL-TIME THROUGHPUT</div>
        <div className="text-right">
          <span className="text-xl font-mono font-black text-cyan-300 tracking-wider">8.652M</span>
          <span className="text-[9px] font-mono text-cyan-400/70 block">CALCULATIONS / SEC</span>
        </div>
      </div>

      {/* Sparkline Waveform SVG */}
      <div className="w-full h-12 relative border border-cyan-500/20 bg-slate-900/40 rounded overflow-hidden p-1">
        <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          {/* Grid lines */}
          <line x1="0" y1="50" x2="100" y2="50" stroke="#00f0ff" strokeWidth="0.5" strokeDasharray="2 2" opacity="0.3" />
          {/* Animated Line */}
          <path
            d={`M ${svgPath}`}
            fill="none"
