...
const MILK_HILL_PDF = '/evidence/crop-circles/Milk_Hill_2001_actual_math_binary_analysis.pdf';
        ...
        {view === 'pdf' && (
          <div className="flex min-h-0 flex-1 flex-col bg-[#03101a]">
            <div className="flex items-center justify-between gap-3 border-b border-cyan-400/25 px-5 py-3">
              <div>
                <div className="text-[10px] tracking-[.24em] text-cyan-400">
                  GIE · READ-ONLY DOCUMENT VIEWER
                </div>
              ...
              <button
                ...
                className="flex shrink-0 items-center gap-2 rounded border border-cyan-400/40 bg-cyan-950/25 px-3 py-2 text-[10px] font-bold tracking-wider text-cyan-200 transition hover:border-cyan-300 hover:bg-cyan-950/50"
              >
                <ChevronLeft size={14} />
                BACK TO EVIDENCE
              </button>
            ...
            <div className="min-h-0 flex-1 p-3">
              <iframe
                src={`${MILK_HILL_PDF}#toolbar=1&navpanes=0&view=FitH`}
                title="Milk Hill 2001 Actual Math and Binary Analysis"
                className="h-full min-h-[70vh] w-full rounded border border-cyan-400/25 bg-white"
              />
            </div>
          </div>
        )}
